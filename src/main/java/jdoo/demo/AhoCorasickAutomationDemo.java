...
public class AhoCorasickAutomationDemo {
    private Logger logger= LoggerFactory.getLogger(AhoCorasickAutomationDemo.class);
    static {
        LoggerFactory.setLoggerProvider(SimpleLogger.PROVIDER);
    }

    public AhoCorasickAutomationDemo() {
    }
    ...
    public void test(){
        ...
        AhoCorasickAutomationDemo aca = new AhoCorasickAutomationDemo();
        aca.setTarget(target);
